...
const December22Page = () => {
  const [audio] = useState(new Audio('/audio/oursong.mp3'));
  ...
  return (
    <>
      <h1 className="title">22 de Diciembre, tu primer dia en Chile Mi Amor</h1>
      <img src="/22diciembre2023.jpg" alt="Imagen de diciembre 22" />
    </>
  );
};

export default December22Page;
