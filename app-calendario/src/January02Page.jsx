...
const Enero02Page = () => {
  const [audio] = useState(new Audio('/audio/hold.mp3'));
  ...
  return (
    <>
      <h1 className="title">02 de enero ✨</h1>
      <img src="/02Enero2024.jpg" alt="Imagen de enero 01" />
    </>
  );
};

export default Enero02Page;