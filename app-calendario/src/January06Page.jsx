...
const Enero06Page = () => {
  const [audio] = useState(new Audio('/audio/world.mp3'));
  ...
  return (
    <>
      <h1 className="title">06 de enero ERES MI VIDA TE AMO</h1>
      <img src="/06Enero2024.jpg" alt="Imagen de enero 06" />
    </>
  );
};

export default Enero06Page;