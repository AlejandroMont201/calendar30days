...
const December23Page = () => {
  const [audio] = useState(new Audio('/audio/fearless.mp3'));
  ...
  return (
    <>
      <h1 className="title">30 de Diciembre, eres lo mejor de mi vida</h1>
      <img src="/30diciembre2023.jpg" alt="Imagen de diciembre 30" />
    </>
  );
};
