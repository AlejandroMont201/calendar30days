...
const Enero04Page = () => {
  const [audio] = useState(new Audio('/audio/changed.mp3'));
  ...
  return (
    <>
      <h1 className="title">04 de enero ✨</h1>
      <img src="/04Enero2024.jpg" alt="Imagen de enero 04" />
    </>
  );
};

export default Enero04Page;